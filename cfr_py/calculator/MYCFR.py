...
class Calculator(_object):
    ...
    def prior_win_rate(self, h0, h1, p0, p1, p2, p3, p4, step, NOP=5, MCtimes=20000):
        return _MYCFR.Calculator_prior_win_rate(self, h0, h1, p0, p1, p2, p3, p4, step, NOP, MCtimes)
